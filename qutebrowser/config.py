...
config.bind('Jb', 'open qute://bookmarks#bookmarks')
# config.bind('Sh', 'open qute://history')
config.bind('Jh', 'open qute://history')
# config.bind('Sq', 'open qute://bookmarks')
config.bind('Jq', 'open qute://bookmarks')
# config.bind('Ss', 'open qute://settings')
config.bind('Js', 'open qute://settings')
...
config.bind('kk', 'set-cmd-text -s :bind')
# config.bind('sl', 'set-cmd-text -s :set -t')
config.bind('kl', 'set-cmd-text -s :set -t')
# config.bind('ss', 'set-cmd-text -s :set')
config.bind('ks', 'set-cmd-text -s :set')
config.bind('jPH', 'config-cycle -p -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('jPh', 'config-cycle -p -u *://{url:host}/* content.plugins ;; reload')
config.bind('jPu', 'config-cycle -p -u {url} content.plugins ;; reload')
config.bind('jSH', 'config-cycle -p -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('jSh', 'config-cycle -p -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('jSu', 'config-cycle -p -u {url} content.javascript.enabled ;; reload')
...
config.bind('jpH', 'config-cycle -p -t -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('jph', 'config-cycle -p -t -u *://{url:host}/* content.plugins ;; reload')
config.bind('jpu', 'config-cycle -p -t -u {url} content.plugins ;; reload')
config.bind('jsH', 'config-cycle -p -t -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('jsh', 'config-cycle -p -t -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('jsu', 'config-cycle -p -t -u {url} content.javascript.enabled ;; reload')
config.bind('u', 'undo')
config.bind('v', 'enter-mode caret')
# config.bind('wB', 'set-cmd-text -s :bookmark-load -w')
config.bind('éB', 'set-cmd-text -s :bookmark-load -w')
# config.bind('wO', 'set-cmd-text :open -w {url:pretty}')
config.bind('éO', 'set-cmd-text :open -w {url:pretty}')
# config.bind('wP', 'open -w -- {primary}')
config.bind('éP', 'open -w -- {primary}')
# config.bind('wb', 'set-cmd-text -s :quickmark-load -w')
config.bind('éb', 'set-cmd-text -s :quickmark-load -w')
# config.bind('wf', 'hint all window')
config.bind('éf', 'hint all window')
# config.bind('wh', 'back -w')
config.bind('éh', 'back -w')
# config.bind('wi', 'inspector')
config.bind('éi', 'inspector')
# config.bind('wl', 'forward -w')
config.bind('él', 'forward -w')
# config.bind('wo', 'set-cmd-text -s :open -w')
config.bind('éo', 'set-cmd-text -s :open -w')
# config.bind('wp', 'open -w -- {clipboard}')
config.bind('ép', 'open -w -- {clipboard}')
...
try:
    PASS_DIR = os.environ['PASSWORD_STORE_DIR']
except KeyError:
    PASS_DIR = os.path.expanduser('~/.password-store')

config.bind(',p', f'spawn --userscript qute-pass --password-store {PASS_DIR}')
