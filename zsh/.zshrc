...
# zsh hooks --------------------------------------------------------------- {{{
# Ref: https://stackoverflow.com/questions/3964068/zsh-automatically-run-ls-after-every-cd#3964198
# Ref: http://zsh.sourceforge.net/Doc/Release/Functions.html#Hook-Functions
